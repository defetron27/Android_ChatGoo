...
import com.def.max.chatgoo.Adapters.FriendsChattingRecyclerAdapter;
...
public class ChatActivity extends AppCompatActivity
{
    ...
    private ArrayList<FriendsMessageModel> friendsMessages = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        chattingRef.child("Friends_Messages").child(onlineUserId).child(receiverUserId).addChildEventListener(new ChildEventListener()
        {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s)
            {
                FriendsMessageModel model = dataSnapshot.getValue(FriendsMessageModel.class);
    ...
    private void storeImageMessageDetails(final Context context, final String onlineUserId, final String friend_key, final Uri imageUri)
    {
        DatabaseReference messageRef = chattingRef.child("Friends_Messages").child(onlineUserId).child(friend_key).push();
            ...
            }).addOnCompleteListener(new OnCompleteListener<Uri>()
            {
                ...
                public void onComplete(@NonNull Task<Uri> task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        chatMessage.put("storage_uri",imageUri.toString());
